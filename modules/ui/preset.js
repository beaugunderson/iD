...
import { access } from './preset/access';
import { address } from './preset/address';
import { check } from './preset/check';
import { combo } from './preset/combo';
import { cycleway } from './preset/cycleway';
import { input } from './preset/input';
import { localized } from './preset/localized';
import { maxspeed } from './preset/maxspeed';
import { radio } from './preset/radio';
import { restrictions } from './preset/restrictions';
import { textarea } from './preset/textarea';
import { wikipedia } from './preset/wikipedia';
